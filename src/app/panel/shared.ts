...
export type Candidato = { id: number; nombre: string; cargo: "legislador" | "concejal" | "delegado_comunal" | "otro"; activo: boolean; bloque_id?: number | null; dni?: string | null; padron_id?: number | null };
